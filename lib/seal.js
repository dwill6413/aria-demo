...
// Keep in sync with walrus.mjs's WALRUS_PUBLISHER_URL. 53 is the actual current
// testnet max_epochs_ahead (confirmed on docs.wal.app/docs/network-reference —
// epoch duration is 1 day, max epochs 53, i.e. ~53 days of storage). The
// previous value here, 183, was based on stale info and is now well past the
// protocol's max — Walrus's publisher rejects anything over the limit, which
// is exactly what was producing "Walrus store failed (500)" on every submit.
const WALRUS_PUBLISHER = 'https://publisher.walrus-testnet.walrus.space/v1/blobs?epochs=53';
