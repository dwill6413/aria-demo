...
**Version:** 2.5 | **Updated:** June 12, 2026
...
⬜ Phase 1f2: P0b — Guest wallet funds escrow (client-side PTB, on P0a's gRPC client) — NEXT UP
...
only public addresses.**ARIA Roadmap v2.5 — June 12, 2026*
*Changes from v2.4: P0a COMPLETE (JSON-RPC → gRPC migration, ahead of Jul 31
deadline) and P1a COMPLETE (arbitrator key separated and wired on-chain).
Documented the working gRPC pattern and the changedObjects "last Created
entry" gotcha (applies to Phase 2's pii_access too). Sandbox approach was
skipped this round (worked out fine via direct Railway iteration, ~6 cycles)
but remains the recommended default for Phase 2's new SDK surface area.
Build order and pre-mainnet gate updated. P0b is next up.*Version:** 2.5 | **Updated:** June 12, 2026
**Purpose:** Complete handoff for an AI assistant continuing ARIA development.
Read this entire document before writing any code.
